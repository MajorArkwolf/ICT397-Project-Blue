...
void Controller::Animator::ReadNodeHeirarchy(const double &AnimationTime, const JointsName& jN,
...
glm::quat Controller::Animator::CalcInterpolatedRotation(double AnimationTime, const AnimJointNode *pNodeAnim) {
    glm::quat Out;
...
glm::vec3 Controller::Animator::CalcInterpolatedPosition(double AnimationTime, const AnimJointNode *pNodeAnim) {
    glm::vec3 Out;
...
void Controller::Animator::LoadAnimation(const std::string& newAnim, bool endWhenCompletedFlag) {
    size_t index = 0;
...
void Controller::Animator::ResetAnimationTime() {
    animationTime = 0.0;
}
